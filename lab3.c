...
// 25 000 000 is half of the 50 Mhz clock cycle of the DE0
#define TIMER_INTERVAL ((volatile unsigned int *) 25000000)
...
void Init (void)
{
	...
	// DECLARE TIMER HI AND LO VARIABLE
	...
	// STORE CORRECT VALUES INTO TIMER HI AND LO
	TIMER_HI = right-shift(TIMER_INTERVAL, 4);
	TIMER_LO = logic-AND(TIMER_INTERVAL, 0x0000FFFF);
